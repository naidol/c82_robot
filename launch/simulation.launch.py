...
def generate_launch_description():
    ...
    robot_dir = LaunchConfiguration(
        'robot_dir',
        default=os.path.join(get_package_share_directory('c82_robot'),
            'robots/'+MY_NEO_ROBOT,
            MY_NEO_ROBOT+'.urdf'))
    ...
    urdf = os.path.join(get_package_share_directory('c82_robot'), 'urdf/'+MY_NEO_ROBOT+'/', MY_NEO_ROBOT+'.urdf')
    ...
    return LaunchDescription([gazebo, spawn_entity, start_robot_state_publisher_cmd, teleop, rviz])